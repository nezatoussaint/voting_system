...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand"  href="process/logout2.php">BACH TO HOME</a>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="process/logout2.php">Back to Home</a></li>
                    </ul>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
        ...
        <div class="col-md-4">
            ...
            <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>" role="form">
                ...
                <div class="form-group-sm">
                    ...
                    <input required type="text" name="stud_id" class="form-control" placeholder="Enter your stud_id">
                </div>
				<div class="form-group-sm">
